...
@endsection
@section('content')
    <div class="bg-white dark:bg-ocean-light dark:bg-opacity-50 shadow-md rounded-sm py-3 bg-opacity-50 backdrop-filter backdrop-blur md:w-2/3 md:mx-auto h-full flex flex-col gap-2 flex-grow my-2">
