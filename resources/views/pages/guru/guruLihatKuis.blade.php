...
@endsection
@section('content')
<div class="flex flex-row gap-2 break-words p-2 text-xs lg:text-lg flex-wrap w-full md:w-3/4 mx-auto">
    <div class="bg-white dark:bg-ocean-light dark:bg-opacity-50 shadow-md rounded-md p-5 flex flex-col bg-opacity-75 flex-shrink w-full">
        ...
        <div class="flex flex-row gap-2 lg:gap-4 break-normal">
            <div class="">
                Kuis dimulai : {{date( 'd M H:i:s', strtotime($dataKuis->batas_awal) )}}
            </div>
            <div class="">
