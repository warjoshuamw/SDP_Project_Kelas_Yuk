<div class="container  xl:w-1/4 lg:w-1/3 sm:w-full md:w-2/3 bg-white  shadow-lg rounded-md transform   duration-200 easy-in-out">
    ...
    <div class=" ">
        <div class="text-center px-2 py-4">
            <h2 class="text-gray-800 text-3xl font-bold">Class Name</h2>
            <p class="text-gray-400 mt-2">Teacher Here</p>
            <hr>
